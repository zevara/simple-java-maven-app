        ...
        stage('Deploy') {
            steps {
                sshagent (credentials: ['ubuntu']) {
                    ...
                    sh "git bundle create kawainekodesu.bundle --all"
                    sh "scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -r kawainekodesu.bundle ubuntu@ec2-54-169-222-38.ap-southeast-1.compute.amazonaws.com:/tmp/"
