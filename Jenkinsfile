        ...
        stage('Deploy') {
            steps {
                sshagent (credentials: ['ubuntu']) {
                    ...
                    sh "ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no ubuntu@ec2-54-169-222-38.ap-southeast-1.compute.amazonaws.com 'cd /tmp/project && ./jenkins/scripts/deliver.sh'"
